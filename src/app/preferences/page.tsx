    ...
    <div className="min-h-screen bg-mesh pt-24 pb-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6 animate-fade-in-up">
          <button onClick={() => router.back()} className="p-2 rounded-xl hover:bg-white/5 text-purple-300/50 hover:text-white transition-all">
            <ArrowLeft className="h-5 w-5" />
          </button>
          <div>
            <h1 className="text-2xl font-bold text-white flex items-center gap-2">
              <SlidersHorizontal className="h-6 w-6 text-purple-400" /> Partner Preferences
            </h1>
            <p className="text-xs text-purple-300/40 mt-0.5">Define what you&apos;re looking for in a life partner</p>
          </div>
        </div>
            ...
            <button key={tab.id} onClick={() => setActiveTab(tab.id)}
              className={`flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-medium whitespace-nowrap transition-all flex-shrink-0 ${
                activeTab === tab.id
                  ...
                  : 'text-purple-300/50 hover:text-purple-200 hover:bg-white/5 border border-transparent'
              }`}>
        ...
        <div className="glass-card animate-fade-in-up">
          ...
          {activeTab === 'basic' && (
            <div className="space-y-5">
              <h3 className="text-sm font-semibold text-white flex items-center gap-2">
                <User className="h-4 w-4 text-purple-400" /> Basic Details
              </h3>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Min Age</label>
                  <select value={prefs.ageMin} onChange={e => setPrefs(p => ({ ...p, ageMin: e.target.value }))} className="input-field text-sm">
                    {Array.from({ length: 20 }, (_, i) => 18 + i).map(age => (
                      <option key={age} value={age} className="bg-dark-900">{age} years</option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Max Age</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Min Height</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Max Height</label>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Marital Status</label>
          ...
          {activeTab === 'community' && (
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Religion</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Community / Caste</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Mother Tongue</label>
          ...
          {activeTab === 'location' && (
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Country</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">State</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">City / District</label>
                ...
                <div className="p-3 bg-purple-500/5 border border-purple-500/10 rounded-xl">
                  <p className="text-[11px] text-purple-300/50 flex items-center gap-1.5">
          ...
          {activeTab === 'education' && (
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Highest Qualification</label>
                  <select value={prefs.qualification} onChange={e => setPrefs(p => ({ ...p, qualification: e.target.value }))} className="input-field text-sm">
                    {['Any Graduate', 'B.Tech/B.E.', 'MBA/PGDM', 'M.Tech/M.E.', 'MBBS/MD', 'CA/CS', 'B.Com', 'B.Sc', 'PhD', "Doesn't Matter"].map(q => (
                      <option key={q} value={q} className="bg-dark-900">{q}</option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Working With</label>
                  <select value={prefs.workingWith} onChange={e => setPrefs(p => ({ ...p, workingWith: e.target.value }))} className="input-field text-sm">
                    {['Private Company', 'Government', 'Business/Self Employed', 'Defence', 'Not Working', "Doesn't Matter"].map(w => (
                      <option key={w} value={w} className="bg-dark-900">{w}</option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Profession</label>
                ...
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Annual Income</label>
          ...
          {activeTab === 'other' && (
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Profile Managed By</label>
                  <select value={prefs.managedBy} onChange={e => setPrefs(p => ({ ...p, managedBy: e.target.value }))} className="input-field text-sm">
                    {['Self', 'Parent/Guardian', 'Sibling', 'Friend', "Doesn't Matter"].map(m => (
                      <option key={m} value={m} className="bg-dark-900">{m}</option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="block text-[11px] text-purple-300/50 mb-1.5">Diet Preference</label>
          ...
          {/* Save Button */}
          <div className="mt-6 pt-5 border-t border-purple-500/10 flex items-center justify-between">
            <p className="text-[10px] text-purple-300/30">Changes auto-apply to your match recommendations</p>
