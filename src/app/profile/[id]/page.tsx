  ...
  return (
    <div className="min-h-screen bg-mesh pt-4 sm:pt-[104px] pb-24 md:pb-12 px-4">
      ...
      {user && user.id !== profile.id && (
        <div className="fixed bottom-16 inset-x-0 z-[80] md:hidden px-4 pb-3">
            ...
            {!interestSent ? (
              <>
                <button onClick={() => setShortlisted(!shortlisted)}
                  ...
                  <span className="text-[9px] font-medium">{shortlisted ? 'Saved' : 'Shortlist'}</span>
                </button>
              ...
              <>
                ...
                <button onClick={() => setShortlisted(!shortlisted)}
                  ...
                  <Star className={`h-5 w-5 ${shortlisted ? 'fill-amber-400' : ''}`} />
                  <span className="text-[9px] font-medium">{shortlisted ? 'Saved' : 'Save'}</span>
                </button>
              </>
            )}
          </div>
