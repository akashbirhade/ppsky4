    ...
    <div className="min-h-screen bg-mesh pt-16 sm:pt-[104px] pb-20">
      <div className={`max-w-7xl mx-auto px-3 sm:px-4 transition-all duration-300 ${chatOpen ? 'xl:pr-80' : 'xl:pr-4'}`}>
        ...
        <div className="flex gap-2 mb-5 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none' }}>
          ...
          {user.premium ? (
            <div className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-amber-500/10 border border-amber-500/20 whitespace-nowrap"><Crown className="h-3.5 w-3.5 text-amber-400" /><span className="text-[10px] text-amber-700 dark:text-amber-200 font-medium">{user.premiumPlan || 'Premium'} ✓</span></div>
          ) : (
